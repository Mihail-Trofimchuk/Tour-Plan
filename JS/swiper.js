      ...
      if (!i.isTouchEvent || 'touchmove' === o.type) {
        ...
        if (!a.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (S(n, { startX: p, startY: c, currentX: p, currentY: c }),
              (i.touchStartTime = x()))
            )
          );
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== n) {
            ...
            S(e, { slides: u, snapGrid: v, slidesGrid: f, slidesSizesGrid: m }),
        ...
        slideTo: function (e, t, a, i) {
          ...
          if (l.cssMode) {
            var x,
              T = r.isHorizontal(),
              C = -g;
            if ((u && (C = h.scrollWidth - h.offsetWidth - C), 0 === t))

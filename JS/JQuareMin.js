...
(function (l, t) {
  ...
  function r(i, b) {
    var k = [q(i.xparallax), q(i.yparallax)];
    this.ontarget = false;
    this.decay = i.decay;
  ...
  function z(i, b) {
    ...
    this.updatePos = function () {
      var h = e.offset() || { left: 0, top: 0 },
        ...
        c = parseInt(e.css('borderTopWidth')) + parseInt(e.css('paddingTop'));
      k.pos = [h.left + j, h.top + c];
    };
    l(window).bind('resize', k.updateSize).bind('resize', k.updatePos);
  ...
  function A(i, b) {
    ...
    this.setParallax = function (d, h, j, c) {
      ...
      for (c = 2; c--; ) {
        ...
        if (typeof j[c] === 'string')
          j[c] = o.percent.test(j[c]) ? parseFloat(j[c]) / 100 : v[j[c]] || 1;
        if (k[c]) {
          e[c] = parseInt(d[c]);
    ...
    this.getPointer = function () {
      for (
        var d = i.offsetParent(), h = i.position(), j = [], c = [], f = 2;
        f--;
        ...
        j[f] = k[f]
          ? 0
          : h[f === 0 ? 'left' : 'top'] /
            (d[f === 0 ? 'outerWidth' : 'outerHeight']() - this.size[f]);
        c[f] = (j[f] - a[f]) / e[f];
      }
      return c;
    };
    ...
    this.setParallax(b.xparallax, b.yparallax, b.xorigin, b.yorigin);
  }
  function s(i) {
    var b = l(this),
      k = i.data,
    ...
    if (k.timeStamp !== i.timeStamp) {
      ...
      a.update(w);
      if (a.active || !g.ontarget) g.update(a.pointer, a.threshold);
    }
    if (d) {
      d.update(e.freeze ? e.freeze.pointer : a.pointer, a.threshold);
      if (d.ontarget) {
        delete e.mouse;
  ...
  var n = 'parallax',
    ...
    v = { left: 0, top: 0, middle: 0.5, center: 0.5, right: 1, bottom: 1 },
  ...
  l.fn[n] = function (i) {
    var b = l.extend({}, l.fn[n].options, i),
      k = arguments,
      e = this;
    if (!(b.mouseport instanceof l)) b.mouseport = l(b.mouseport);
    ...
    return e
      ...
      .each(function (a) {
        ...
        var d = new A(g, a);
        g.data(n, { layer: d, mouse: new r(a, d.getPointer()) });
      });
  };
  l.fn[n].options = x;
